...
%% plot of phytoplankton when mortality (m) changes

m_values=linspace(0.1, 0.4, 4);
legende=strings(length(m_values),1);
...
for i=1:length(m_values)
    ...
    legende(i)=(strcat('m =', num2str(m_values(i)),' d^-1'));
    hold on
end
legend(legende)
...
%% plot of nutrients when mortality (m) changes
